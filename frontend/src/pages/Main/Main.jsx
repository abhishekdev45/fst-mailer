  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-indigo-200 via-red-200 to-yellow-100">
      ...
      <div className="grid w-full place-items-center py-4 z-10 text-[#015a73] px-4 mt-12">
        <p className="text-4xl md:text-8xl font-[Poppins] font-bold py-2">
          Presenting{" "}
          <span className="bg-gradient-to-r from-blue-600 to-lime-600 bg-clip-text text-transparent">
            FST Mailer
          </span>
        </p>

        <p className="text-2xl md:text-5xl font-[Poppins] font-bold py-2 flex flex-wrap">
          Elevate Your{" "}
          <span className="bg-gradient-to-r from-blue-600 to-lime-600 bg-clip-text text-transparent px-1">
            Email Communication
          </span>{" "}
          with FST Mailer.
        </p>

        <p className="text-2xl md:text-4xl font-[Poppins] font-bold py-2 flex flex-wrap">
          Code-Free{" "}
          <span className="bg-gradient-to-r from-blue-600 to-lime-600 bg-clip-text text-transparent px-1">
            HTML Mails
          </span>
      ...
      <div className="grid w-full place-items-center py-4 z-10 text-gray-500 px-4 mt-4">
        <p className="text-md md:text-xl font-[Poppins] font-bold py-2 flex flex-wrap">
          OR
        </p>
